...
# Attendee #22 - 2019-guug-ffg-workshop-22
module "hcloud_kubernetes_attendee_22_master" {
  source = "./platforms/hcloud/server"
...
module "hcloud_kubernetes_attendee_22_worker" {
  source = "./platforms/hcloud/server"
...
# Attendee #23 - 2019-guug-ffg-workshop-23
module "hcloud_kubernetes_attendee_23_master" {
  source = "./platforms/hcloud/server"
...
module "hcloud_kubernetes_attendee_23_worker" {
  source = "./platforms/hcloud/server"
...
# Attendee #24 - 2019-guug-ffg-workshop-24
module "hcloud_kubernetes_attendee_24_master" {
  source = "./platforms/hcloud/server"
...
module "hcloud_kubernetes_attendee_24_worker" {
  source = "./platforms/hcloud/server"
...
# Attendee #25 - 2019-guug-ffg-workshop-25
module "hcloud_kubernetes_attendee_25_master" {
  source = "./platforms/hcloud/server"
...
module "hcloud_kubernetes_attendee_25_worker" {
  source = "./platforms/hcloud/server"
